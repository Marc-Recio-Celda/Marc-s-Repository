...
:thumbs_up:, which will be automatically converted to 👍. Some programs additionally support aliases, whereby you can more succinctly type, for instance,
...
def main():
    emojis = input("").strip()
    print(emoji.emojize(emojis, language="alias"))
